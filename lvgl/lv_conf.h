...
#define LV_VDB_SIZE         ( LV_VER_RES * LV_HOR_RES * 50 / 100)  /*Size of VDB in pixel count (1/10 screen size is good for first)*/
...
#define LV_VDB2_ADR         1       /*Place VDB2 to a specific address (e.g. in external RAM) (0: allocate automatically into RAM)*/
